...
import com.cgomez.ncselftraining.util.BinarySearch;
import com.cgomez.ncselftraining.util.Stemmer;
...
//}		
	...
	public VetorSimilaridade getVetorSimilaridade(Artigo artigo) {
		...
		*/
		...
		vetor[3]=0;
		vetor[3]= com.cgomez.ncselftraining.hhc.Similarity.ComparacaoFragmentos(getAutor(), artigo.getAutor(), 0.2)
				? 1 : 0;
