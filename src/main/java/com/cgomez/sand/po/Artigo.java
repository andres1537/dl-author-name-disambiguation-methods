...
import com.cgomez.sand.util.BinarySearch;
import com.cgomez.sand.util.Stemmer;
...
//}		
	...
	public VetorSimilaridade getVetorSimilaridade(Artigo artigo) {
		...
		*/
		...
		vetor[3]=0;
		vetor[3]= com.cgomez.sand.hhc.Similarity.ComparacaoFragmentos(getAutor(), artigo.getAutor(), 0.2)
				? 1 : 0;
