...
public class CrossValidation {
    ...
    public void dataSetKIST(int numFolds, boolean sp) throws IOException{
        String set = "kisti";
    ...
    public void dataSetBDBComp(int numFolds, boolean sp) throws IOException{
        String set = "bdbcomp";
    ...
    public void dataSetDBLP(int numFolds, boolean sp) throws IOException{
        String set = "dblp";
    ...
    private void execute(String[] groups, String dataset, String collection, int numFolds, boolean sp, double tp) throws IOException{
        ...
        for (String ambiguousGroup: groups){
            ...
            for (int i=0; i<numFolds; i++){
                ...
                NC nc = new NC(0.5, 0.3, 0.2, 0.2, 0.0, 0.2, 0.1, true);
                if (sp){
                    nc.train(train);
        ...
        //ClassificationData.serializeData(NC.logClassification, experiment);
        //NC.analyseClassificationData();
    }
