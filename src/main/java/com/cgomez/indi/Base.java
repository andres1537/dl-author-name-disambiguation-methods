...
/*      */ public class Base
/*      */ {
/*   20 */   private static String[] authors = { "AGupta", "AKumar", "CChen", 
/*   21 */     "DJohnson", "JLee", "JMartin", "JRobinson", "JSmith", "KTanaka", 
/*   22 */     "MBrown", "MJones", "MMiller", "SLee", "YChen" };
/*      */   
/*   24 */   private ArrayList<Artigo> artigos = new ArrayList();
/*      */   
/*      */   ArrayList<TermOcurrence> lstTerm;
/*      */   
/*      */   public void addToLstTerm(ArrayList<TermOcurrence> lst)
/*      */   {
/*   30 */     HashSet<String> h = new HashSet();
/*   31 */     for (TermOcurrence t : this.lstTerm) {
/*   32 */       h.add(t.getTerm());
/*      */     }
/*      */     
/*   35 */     for (TermOcurrence t : lst) {
/*   36 */       if (!h.contains(t.getTerm())) {
/*   37 */         this.lstTerm.add(t);
/*      */       }
/*      */     }
/*   40 */     Collections.sort(this.lstTerm);
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*   46 */     int qtde = 0;
/*   47 */     for (int i = 0; i < this.artigos.size(); i++) {
/*   48 */       if (((Artigo)this.artigos.get(i)).isTreino())
/*   49 */         qtde++;
/*      */     }
/*   51 */     return qtde;
/*      */   }
...
/*      */     throws IOException
/*      */   {
/*   70 */     BufferedReader arqFontes = new BufferedReader(new FileReader(nomeArqFontes));
/*   71 */     BufferedReader arqTitulos = new BufferedReader(new FileReader(nomeArqTitulos));
/*      */     String linhaF;
/*   73 */     while ((linhaF = arqFontes.readLine()) != null) { String linhaF;
/*   74 */       String[] arrayMetadados = linhaF.split("<>");
/*   75 */       String[] linhaT = arqTitulos.readLine().split("<>");
/*      */       String titulo;
/*   77 */       String titulo; if (linhaT.length > 1) {
/*   78 */         titulo = linhaT[1];
/*      */       } else
/*   80 */         titulo = linhaT[0];
/*   81 */       int numArtigo = Integer.parseInt(arrayMetadados[0]);
/*   82 */       String[] classe = arrayMetadados[1].split("\\_");
/*   83 */       int numClasse = Integer.parseInt(classe[0]);
/*   84 */       int numArtClasse = Integer.parseInt(classe[1]);
/*   85 */       String[] coautores = arrayMetadados[2].split("\\:");
/*   86 */       if (coautores[0].equals("undefined")) {
/*   87 */         coautores = null;
/*      */       }
/*   89 */       String veiculoPublicacao = arrayMetadados[3];
/*   90 */       String autor = arrayMetadados[4];
/*   91 */       Artigo artigo = new Artigo(numArtigo, numClasse, numArtClasse, 
/*   92 */         autor, coautores, titulo, veiculoPublicacao);
/*      */       
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*   98 */       this.artigos.add(artigo);
/*      */     }
/*  100 */     this.lstTerm = criaListaTermos(separado);
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*  105 */     arqFontes.close();
/*  106 */     arqTitulos.close();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws IOException
/*      */   {
/*  116 */     BufferedReader arqFontes = new BufferedReader(new FileReader(nomeArqFontes));
/*  117 */     BufferedReader arqTitulos = new BufferedReader(new FileReader(nomeArqTitulos));
/*      */     String linhaF;
/*  119 */     while ((linhaF = arqFontes.readLine()) != null) { String linhaF;
/*  120 */       String[] arrayMetadados = linhaF.split("<>");
/*  121 */       String[] linhaT = arqTitulos.readLine().split("<>");
/*      */       String titulo;
/*  123 */       String titulo; if (linhaT.length > 1) {
/*  124 */         titulo = linhaT[1];
/*      */       } else
/*  126 */         titulo = linhaT[0];
/*  127 */       int numArtigo = Integer.parseInt(arrayMetadados[0]);
/*  128 */       String[] classe = arrayMetadados[1].split("\\_");
/*  129 */       int numClasse = Integer.parseInt(classe[0]);
/*  130 */       int numArtClasse = Integer.parseInt(classe[1]);
/*  131 */       String[] coautores = arrayMetadados[2].split("\\:");
/*  132 */       if (coautores[0].equals("undefined")) {
/*  133 */         coautores = null;
/*      */       }
/*  135 */       String veiculoPublicacao = arrayMetadados[3];
/*  136 */       String autor = arrayMetadados[4];
/*  137 */       Artigo artigo = new Artigo(numArtigo, numClasse, numArtClasse, 
/*  138 */         autor, coautores, titulo, veiculoPublicacao);
/*  139 */       artigo.svm = Integer.parseInt(arrayMetadados[5]);
/*  140 */       artigo.nb = Integer.parseInt(arrayMetadados[5]);
/*  141 */       artigo.lac = Integer.parseInt(arrayMetadados[5]);
/*      */       
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  147 */       this.artigos.add(artigo);
/*      */     }
/*  149 */     this.lstTerm = criaListaTermos(separado);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws IOException
/*      */   {
/*  163 */     BufferedReader arqFontes = new BufferedReader(new FileReader(nomeArqFontes + numTeste));
/*      */     boolean achou;
/*  165 */     int i; String linhaF; for (; (linhaF = arqFontes.readLine()) != null; 
/*      */         
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  171 */         (!achou) && (i < this.artigos.size()))
/*      */     {
/*      */       String linhaF;
/*  166 */       String[] arrayMetadados = linhaF.split("<>");
/*      */       
/*  168 */       int numArtigo = Integer.parseInt(arrayMetadados[0]);
/*  169 */       achou = false;
/*  170 */       i = 0;
/*  171 */       continue;
/*  172 */       if (((Artigo)this.artigos.get(i)).getNumArtigo() == numArtigo) {
/*  173 */         ((Artigo)this.artigos.get(i)).setTreino(false);
/*  174 */         achou = true;
/*      */       } else {
/*  176 */         i++;
/*      */       }
...
/*      */     throws IOException
/*      */   {
/*  191 */     BufferedReader arqFontes = new BufferedReader(new FileReader(nomeArqFontes));
/*      */     String linhaF;
/*  193 */     while ((linhaF = arqFontes.readLine()) != null) { String linhaF;
/*  194 */       String[] arrayMetadados = linhaF.split("<>");
/*      */       
/*  196 */       int numArtigo = Integer.parseInt(arrayMetadados[0]);
/*  197 */       boolean achou = false;
/*  198 */       int i = 0;
/*  199 */       while ((!achou) && (i < this.artigos.size()))
/*  200 */         if (((Artigo)this.artigos.get(i)).getNumArtigo() == numArtigo) {
/*  201 */           ((Artigo)this.artigos.get(i)).setTreino(false);
/*  202 */           achou = true;
/*      */         } else {
/*  204 */           i++; }
/*  205 */       if (!achou) {
/*  206 */         System.out.println("Nï¿½o achou teste: " + numArtigo);
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*      */     throws IOException
/*      */   {
/*  234 */     int qtdeAuthors = 0;
/*  235 */     int baseNumClasse = 0;
/*  236 */     int maxClasse = 0;
/*  237 */     BufferedReader arqFontes = new BufferedReader(new FileReader(nomeArq));
/*  238 */     this.artigos = new ArrayList();
/*  239 */     maxClasse = 0;
/*  240 */     String linha; while ((linha = arqFontes.readLine()) != null) { String linha;
/*  241 */       String[] arrayMetadados = linha.split("<>");
/*      */       
/*  243 */       int numArtigo = Integer.parseInt(arrayMetadados[0]);
/*  244 */       String[] classe = arrayMetadados[1].split("\\_");
/*  245 */       int numClasse = Integer.parseInt(classe[0]);
/*  246 */       int numArtClasse = Integer.parseInt(classe[1]);
/*  247 */       String[] coautores = arrayMetadados[2].split("\\:");
/*      */       
/*  249 */       if ((coautores[0].equals("undefined")) || (coautores[0].length() == 0))
/*  250 */         coautores = null;
/*  251 */       String titulo = arrayMetadados[3];
/*  252 */       String veiculoPublicacao = arrayMetadados[4];
/*  253 */       String autor = arrayMetadados[5];
/*  254 */       Artigo artigo = new Artigo(numArtigo, numClasse, numArtClasse, 
/*  255 */         autor, coautores, titulo, veiculoPublicacao);
/*  256 */       this.artigos.add(artigo);
/*      */     }
/*  258 */     arqFontes.close();
/*      */     
/*      */ 
...
/*      */ 
/*      */ 
/*  264 */     this.lstTerm = criaListaTermos(separado);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws IOException
/*      */   {
/*  272 */     int qtdeAuthors = 0;
/*  273 */     int baseNumClasse = 0;
/*  274 */     int maxClasse = 0;
/*  275 */     BufferedReader arqFontes = new BufferedReader(new FileReader(nomeArq));
/*  276 */     this.artigos = new ArrayList();
/*  277 */     maxClasse = 0;
/*  278 */     String linha; while ((linha = arqFontes.readLine()) != null) { String linha;
/*  279 */       String[] arrayMetadados = linha.split("<>");
/*      */       
/*  281 */       int numArtigo = Integer.parseInt(arrayMetadados[0]);
/*  282 */       String[] autores = arrayMetadados[1].split("\\:");
/*      */       
/*  284 */       if ((autores[0].equals("undefined")) || (autores[0].length() == 0))
/*  285 */         autores = null;
/*  286 */       String titulo = arrayMetadados[2];
/*  287 */       String veiculoPublicacao = arrayMetadados[3];
/*  288 */       String autor = autores[0];
/*      */       
/*  290 */       Artigo artigo = new Artigo(numArtigo, Integer.parseInt(autor), 
/*  291 */         numArtigo, autor, autores, titulo, veiculoPublicacao);
/*  292 */       this.artigos.add(artigo);
/*      */     }
/*  294 */     arqFontes.close();
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*  299 */     this.lstTerm = criaListaTermos(separado);
/*      */   }
/*      */   
/*      */   public static void main(String[] args) throws IOException {
/*  303 */     Base b = new Base();
/*  304 */     b.leituraBase(args[0], true);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  318 */     int inicio = 0;int fim = 0;
/*  319 */     while ((inicio < this.artigos.size()) && 
/*  320 */       (((Artigo)this.artigos.get(inicio)).getNumClasse() != classe))
/*  321 */       inicio++;
/*  322 */     fim = inicio;
/*  323 */     while ((fim < this.artigos.size()) && 
/*  324 */       (((Artigo)this.artigos.get(fim)).getNumClasse() == classe))
/*  325 */       fim++;
/*  326 */     if (inicio < this.artigos.size()) {
/*  327 */       ArrayList<VetorSimilaridade> vetores = new ArrayList();
/*  328 */       for (int i = inicio; i < fim - 1; i++) {
/*  329 */         for (int j = i + 1; j < fim; j++) {
/*  330 */           vetores.add(((Artigo)this.artigos.get(i)).getVetorSimilaridade(
/*  331 */             (Artigo)this.artigos.get(j)));
/*      */         }
/*      */       }
/*  334 */       return vetores;
/*      */     }
...
/*      */   {
/*  351 */     ArrayList<Artigo> lstArtigo = blc.getArtigos();
/*  352 */     int inicio = 0;int fim = lstArtigo.size();
/*      */     
/*  354 */     if (inicio < lstArtigo.size()) {
/*  355 */       ArrayList<VetorSimilaridade> vetores = new ArrayList();
/*  356 */       for (int i = inicio; i < fim - 1; i++) {
/*  357 */         for (int j = i + 1; j < fim; j++) {
/*  358 */           vetores.add(((Artigo)this.artigos.get(i)).getVetorSimilaridade(
/*  359 */             (Artigo)this.artigos.get(j)));
/*      */         }
/*      */       }
/*  362 */       return vetores;
/*      */     }
...
/*      */   {
/*  378 */     ArrayList<Bloco> blocos = new ArrayList();
/*  379 */     Bloco bloco = new Bloco();
/*  380 */     blocos.add(bloco);
/*  381 */     if (this.artigos.size() > 0) {
/*  382 */       boolean adicionou = false;
/*  383 */       bloco.add((Artigo)this.artigos.get(0));
/*  384 */       for (int i = 1; i < this.artigos.size(); i++) {
/*  385 */         String autor = ((Artigo)this.artigos.get(i)).getAutor();
/*  386 */         adicionou = false;
/*  387 */         int j = 0;
/*  388 */         while ((!adicionou) && (j < blocos.size()))
/*      */         {
/*  390 */           if (metric.getSimilarity(((Artigo)((Bloco)blocos.get(j)).getArtigos().get(0)).getAutor(), autor) >= d) {
/*  391 */             ((Bloco)blocos.get(j)).add((Artigo)this.artigos.get(i));
/*  392 */             adicionou = true;
/*      */           }
/*  394 */           j++;
/*      */         }
/*  396 */         if (!adicionou) {
/*  397 */           bloco = new Bloco();
/*  398 */           bloco.add((Artigo)this.artigos.get(i));
/*  399 */           blocos.add(bloco);
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/*      */   {
/*  409 */     ArrayList<GrupoAmbiguo> blocos = new ArrayList();
/*      */     
/*  411 */     if (this.artigos.size() > 0) {
/*  412 */       boolean adicionou = false;
/*  413 */       String[] v_autor = ((Artigo)this.artigos.get(0)).getAutorIFFL().split(" ");
/*  414 */       GrupoAmbiguo bloco = new GrupoAmbiguo(((Artigo)this.artigos.get(0)).getAutorIFFL()
/*  415 */         .charAt(0), v_autor[(v_autor.length - 1)]);
/*  416 */       blocos.add(bloco);
/*  417 */       bloco.add((Artigo)this.artigos.get(0));
/*  418 */       for (int i = 1; i < this.artigos.size(); i++) {
/*  419 */         String autor = ((Artigo)this.artigos.get(i)).getAutor();
/*  420 */         adicionou = false;
/*  421 */         int j = 0;
/*  422 */         while ((!adicionou) && (j < blocos.size()))
/*      */         {
/*  424 */           if (metric.getSimilarity(((Artigo)((GrupoAmbiguo)blocos.get(j)).getArtigos().get(0)).getAutor(), autor) >= d) {
/*  425 */             ((GrupoAmbiguo)blocos.get(j)).add((Artigo)this.artigos.get(i));
/*  426 */             adicionou = true;
/*      */           }
/*  428 */           j++;
/*      */         }
/*  430 */         if (!adicionou) {
/*  431 */           v_autor = ((Artigo)this.artigos.get(i)).getAutorIFFL().split(" ");
/*  432 */           bloco = new GrupoAmbiguo(v_autor[0].charAt(0), 
/*  433 */             v_autor[(v_autor.length - 1)]);
/*  434 */           bloco.add((Artigo)this.artigos.get(i));
/*  435 */           blocos.add(bloco);
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/*  444 */     Hashtable<String, String> h = new Hashtable();
/*  445 */     String[] terms; int i; for (Iterator localIterator = getArtigos().iterator(); localIterator.hasNext(); 
/*      */         
/*  447 */         i < terms.length)
/*      */     {
/*  445 */       Artigo a = (Artigo)localIterator.next();
/*  446 */       terms = a.getTitulo().split(" ");
/*  447 */       i = 0; continue;
/*  448 */       h.put(terms[i], terms[i]);i++;
/*      */     }
/*      */     
/*      */ 
/*  451 */     return new ArrayList(h.values());
/*      */   }
/*      */   
/*      */   public List getListCoautores() {
/*  455 */     Hashtable<String, String> h = new Hashtable();
/*  456 */     for (Artigo a : getArtigos()) {
/*  457 */       String[] terms = a.getCoautoresIFFL();
/*  458 */       if (terms != null) {
/*  459 */         for (int i = 0; i < terms.length; i++)
/*  460 */           h.put(terms[i], terms[i]);
/*      */       }
/*      */     }
/*  463 */     return new ArrayList(h.values());
/*      */   }
/*      */   
/*      */   public List getListVenues() {
/*  467 */     Hashtable<String, String> h = new Hashtable();
/*  468 */     for (Artigo a : getArtigos()) {
/*  469 */       String terms = a.getVeiculoPublicacao();
/*  470 */       h.put(terms, terms);
/*      */     }
/*  472 */     return new ArrayList(h.values());
/*      */   }
/*      */   
/*      */   public ArrayList<TermOcurrence> criaListaTermos(boolean separado) {
/*  476 */     ArrayList<TermOcurrence> listaTermos = new ArrayList();
/*      */     
/*  478 */     Iterator<Artigo> iArtigos = this.artigos.iterator();
/*  479 */     while (iArtigos.hasNext()) {
/*  480 */       Artigo artigo = (Artigo)iArtigos.next();
/*  481 */       listaTermos.addAll(artigo.getListaTermos(separado));
/*      */     }
/*      */     
/*      */ 
/*  485 */     Collections.sort(listaTermos);
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  491 */     int i = 0;
/*  492 */     while (i < listaTermos.size() - 1) {
/*  493 */       if (((TermOcurrence)listaTermos.get(i)).getTerm().equals(
/*  494 */         ((TermOcurrence)listaTermos.get(i + 1)).getTerm())) {
/*  495 */         ((TermOcurrence)listaTermos.get(i)).setOcurrence(
/*  496 */           ((TermOcurrence)listaTermos.get(i)).getOcurrence() + 1);
/*  497 */         listaTermos.remove(i + 1);
/*      */       } else {
/*  499 */         i++;
/*      */       }
/*      */     }
/*  502 */     return listaTermos;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  510 */     ArrayList<FeatureVector> vetores = new ArrayList();
/*      */     
/*  512 */     Iterator<Artigo> iArtigos = this.artigos.iterator();
/*  513 */     while (iArtigos.hasNext()) {
/*  514 */       Artigo artigo = (Artigo)iArtigos.next();
/*      */       
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  521 */       vetores.add(artigo.getFeatureVector(this.lstTerm, separado, 't', this.artigos
/*  522 */         .size()));
/*      */     }
/*  524 */     return vetores;
/*      */   }
...
/*      */   {
/*  788 */     int i = 0;
/*  789 */     for (TermOcurrence t : lst) {
/*  790 */       System.out.println(i++ + ":" + t.getTerm() + "\t" + 
/*  791 */         t.getOcurrence());
/*      */     }
/*      */   }
/*      */   
...
/*  929 */     double PG = 0.0D;
/*  930 */     int qtdeGrp = 0;
/*  931 */     Iterator<Artigo> iArtigos = this.artigos.iterator();
/*  932 */     while (iArtigos.hasNext()) {
/*  933 */       Artigo artigo = (Artigo)iArtigos.next();
/*  934 */       if ((!artigo.isTreino()) && (artigo.getNumClasseRecebida() == grupo)) {
/*  935 */         qtdeGrp++;
/*  936 */         if (artigo.getNumClasseRecebida() == artigo.getNumClasse())
/*  937 */           PG += 1.0D;
/*      */       }
/*      */     }
/*  940 */     PG = qtdeGrp != 0 ? Math.pow(PG, 2.0D) / qtdeGrp : 0.0D;
/*  941 */     return PG;
/*      */   }
/*      */   
/*      */ 
...
/*  948 */     double PG = 0.0D;
/*  949 */     int qtdeGrp = 0;
/*  950 */     Iterator<Artigo> iArtigos = this.artigos.iterator();
/*  951 */     while (iArtigos.hasNext()) {
/*  952 */       Artigo artigo = (Artigo)iArtigos.next();
/*  953 */       if ((!artigo.isTreino()) && (artigo.getNumClasse() == grupo)) {
/*  954 */         qtdeGrp++;
/*  955 */         if (artigo.getNumClasseRecebida() == artigo.getNumClasse())
/*  956 */           PG += 1.0D;
/*      */       }
/*      */     }
/*  959 */     PG = qtdeGrp != 0 ? Math.pow(PG, 2.0D) / qtdeGrp : 0.0D;
/*  960 */     return PG;
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*  972 */     double PMG = 0.0D;double PMA = 0.0D;
/*      */     
/*  974 */     int N = 0;
/*  975 */     N = this.artigos.size();
/*  976 */     for (int i = inicio; i <= fim; i++) {
/*  977 */       double PG = calculaPG(i);
/*  978 */       double PA = calculaPA(i);
/*      */       
/*  980 */       if (PG > 0.0D) {
/*  981 */         PMG += PG;
/*      */       }
...
/*  990 */     PMG /= N;
/*  991 */     PMA /= N;
/*  992 */     System.out.println("PMG: " + PMG + "\tPMA: " + PMA + "\tK= " + 
/*  993 */       Math.sqrt(PMA * PMG));
/*      */   }
/*      */   
/*      */   public double calculaPMG(int inicio, int fim)
/*      */   {
/*  998 */     double nij = 0.0D;double ni = 0.0D;double N = 0.0D;double PMG = 0.0D;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/* 1008 */     int q = fim;
/*      */     
/* 1010 */     Iterator<Artigo> iArtigos = this.artigos.iterator();
/* 1011 */     while (iArtigos.hasNext()) {
/* 1012 */       Artigo artigo = (Artigo)iArtigos.next();
/* 1013 */       if ((!artigo.isTreino()) && (
/* 1014 */         ((artigo.getNumClasse() >= inicio) && 
/* 1015 */         (artigo.getNumClasse() <= fim)) || (
/* 1016 */         (artigo.getNumClasseRecebida() >= inicio) && 
/* 1017 */         (artigo.getNumClasseRecebida() <= fim))))
/* 1018 */         N += 1.0D;
/*      */     }
/* 1020 */     for (int i = inicio; i <= q; i++)
/*      */     {
/* 1022 */       ni = 0.0D;
/* 1023 */       iArtigos = this.artigos.iterator();
/* 1024 */       while (iArtigos.hasNext()) {
/* 1025 */         Artigo artigo = (Artigo)iArtigos.next();
/* 1026 */         if ((!artigo.isTreino()) && (artigo.getNumClasseRecebida() == i))
/* 1027 */           ni += 1.0D;
/*      */       }
/* 1029 */       for (int j = inicio; j <= R; j++) {
/* 1030 */         nij = 0.0D;
/* 1031 */         iArtigos = this.artigos.iterator();
/* 1032 */         while (iArtigos.hasNext()) {
/* 1033 */           Artigo artigo = (Artigo)iArtigos.next();
/* 1034 */           if ((!artigo.isTreino()) && 
/* 1035 */             (artigo.getNumClasseRecebida() == i) && 
/* 1036 */             (artigo.getNumClasse() == j)) {
/* 1037 */             nij += 1.0D;
/*      */           }
/*      */         }
/*      */         
/* 1041 */         PMG += (ni > 0.0D ? Math.pow(nij, 2.0D) / ni : 0.0D);
/*      */       }
/*      */     }
/*      */     
/*      */ 
...
/* 1051 */     double nij = 0.0D;double nj = 0.0D;double N = 0.0D;double PMA = 0.0D;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/* 1061 */     int q = fim;
/*      */     
/* 1063 */     Iterator<Artigo> iArtigos = this.artigos.iterator();
/* 1064 */     while (iArtigos.hasNext()) {
/* 1065 */       Artigo artigo = (Artigo)iArtigos.next();
/* 1066 */       if ((!artigo.isTreino()) && (
/* 1067 */         ((artigo.getNumClasse() >= inicio) && 
/* 1068 */         (artigo.getNumClasse() <= fim)) || (
/* 1069 */         (artigo.getNumClasseRecebida() >= inicio) && 
/* 1070 */         (artigo.getNumClasseRecebida() <= fim))))
/* 1071 */         N += 1.0D;
/*      */     }
/* 1073 */     for (int j = inicio; j <= R; j++) {
/* 1074 */       nj = 0.0D;
/* 1075 */       iArtigos = this.artigos.iterator();
/* 1076 */       while (iArtigos.hasNext()) {
/* 1077 */         Artigo artigo = (Artigo)iArtigos.next();
/* 1078 */         if ((!artigo.isTreino()) && (artigo.getNumClasse() == j)) {
/* 1079 */           nj += 1.0D;
/*      */         }
/*      */       }
/* 1082 */       for (int i = inicio; i <= q; i++) {
/* 1083 */         nij = 0.0D;
/* 1084 */         iArtigos = this.artigos.iterator();
/* 1085 */         while (iArtigos.hasNext()) {
/* 1086 */           Artigo artigo = (Artigo)iArtigos.next();
/* 1087 */           if ((!artigo.isTreino()) && (artigo.getNumClasse() == j) && 
/* 1088 */             (artigo.getNumClasseRecebida() == i)) {
/* 1089 */             nij += 1.0D;
/*      */           }
/*      */         }
/* 1092 */         PMA += (nj > 0.0D ? Math.pow(nij, 2.0D) / nj : 0.0D);
/*      */       }
/*      */     }
/*      */     
/* 1096 */     PMA /= N;
...
/* 1101 */     double total = 0.0D;double certos = 0.0D;
/* 1102 */     Iterator<Artigo> i = this.artigos.iterator();
/* 1103 */     while (i.hasNext()) {
/* 1104 */       Artigo artigo = (Artigo)i.next();
/* 1105 */       if ((!artigo.isTreino()) && 
/* 1106 */         (artigo.getNumClasse() >= inicio) && 
/* 1107 */         (artigo.getNumClasse() <= fim)) {
/* 1108 */         total += 1.0D;
/* 1109 */         if (artigo.getNumClasse() == artigo.getNumClasseRecebida()) {
/* 1110 */           certos += 1.0D;
/*      */         }
/*      */       }
/*      */     }
/* 1114 */     return total != 0.0D ? certos / total : 0.0D;
/*      */   }
/*      */   
/*      */   public double accurracyBase() {
/* 1118 */     double total = 0.0D;double certos = 0.0D;
/* 1119 */     Iterator<Artigo> i = this.artigos.iterator();
/* 1120 */     while (i.hasNext()) {
/* 1121 */       Artigo artigo = (Artigo)i.next();
/* 1122 */       total += 1.0D;
/* 1123 */       if (artigo.getNumClasse() == artigo.getNumClasseRecebida())
/* 1124 */         certos += 1.0D;
/*      */     }
/* 1126 */     return total != 0.0D ? certos / total : 0.0D;
/*      */   }
/*      */   
/*      */   /* Error */
...
/*      */   {
/* 1198 */     ArrayList<GrupoAmbiguo> grupos = new ArrayList();
/* 1199 */     grupos.add(new GrupoAmbiguo('a', "gupta"));
/* 1200 */     grupos.add(new GrupoAmbiguo('a', "kumar"));
/* 1201 */     grupos.add(new GrupoAmbiguo('c', "chen"));
/* 1202 */     grupos.add(new GrupoAmbiguo('d', "johnson"));
/* 1203 */     grupos.add(new GrupoAmbiguo('j', "lee"));
/* 1204 */     grupos.add(new GrupoAmbiguo('j', "martin"));
/* 1205 */     grupos.add(new GrupoAmbiguo('j', "robinson"));
/* 1206 */     grupos.add(new GrupoAmbiguo('j', "smith"));
/* 1207 */     grupos.add(new GrupoAmbiguo('k', "tanaka"));
/* 1208 */     grupos.add(new GrupoAmbiguo('m', "brown"));
/* 1209 */     grupos.add(new GrupoAmbiguo('m', "jones"));
/* 1210 */     grupos.add(new GrupoAmbiguo('m', "miller"));
/* 1211 */     grupos.add(new GrupoAmbiguo('s', "lee"));
/* 1212 */     grupos.add(new GrupoAmbiguo('y', "chen"));
/*      */     
/* 1214 */     Iterator<Artigo> iArt = this.artigos.iterator();
/* 1215 */     while (iArt.hasNext()) {
/* 1216 */       Artigo artigo = (Artigo)iArt.next();
/* 1217 */       if ((artigo.getNumClasse() >= 0) && (artigo.getNumClasse() <= 25))
/*      */       {
/* 1219 */         ((GrupoAmbiguo)grupos.get(0)).add(artigo);
/* 1220 */       } else if ((artigo.getNumClasse() >= 55) && (artigo.getNumClasse() <= 68))
/*      */       {
/* 1222 */         ((GrupoAmbiguo)grupos.get(1)).add(artigo);
/* 1223 */       } else if ((artigo.getNumClasse() >= 94) && 
/* 1224 */         (artigo.getNumClasse() <= 154)) {
/* 1225 */         ((GrupoAmbiguo)grupos.get(2)).add(artigo);
/* 1226 */       } else if ((artigo.getNumClasse() >= 197) && 
/* 1227 */         (artigo.getNumClasse() <= 211)) {
/* 1228 */         ((GrupoAmbiguo)grupos.get(3)).add(artigo);
/* 1229 */       } else if ((artigo.getNumClasse() >= 0) && (artigo.getNumClasse() <= -1))
/*      */       {
/* 1231 */         ((GrupoAmbiguo)grupos.get(4)).add(artigo);
/* 1232 */       } else if ((artigo.getNumClasse() >= 26) && (artigo.getNumClasse() <= 41))
/*      */       {
/* 1234 */         ((GrupoAmbiguo)grupos.get(5)).add(artigo);
/* 1235 */       } else if ((artigo.getNumClasse() >= 69) && (artigo.getNumClasse() <= 80))
/*      */       {
/* 1237 */         ((GrupoAmbiguo)grupos.get(6)).add(artigo);
/* 1238 */       } else if ((artigo.getNumClasse() >= 155) && 
/* 1239 */         (artigo.getNumClasse() <= 184)) {
/* 1240 */         ((GrupoAmbiguo)grupos.get(7)).add(artigo);
/* 1241 */       } else if ((artigo.getNumClasse() >= 212) && 
/* 1242 */         (artigo.getNumClasse() <= 221)) {
/* 1243 */         ((GrupoAmbiguo)grupos.get(8)).add(artigo);
/* 1244 */       } else if ((artigo.getNumClasse() >= 42) && (artigo.getNumClasse() <= 54))
/*      */       {
/* 1246 */         ((GrupoAmbiguo)grupos.get(9)).add(artigo);
/* 1247 */       } else if ((artigo.getNumClasse() >= 81) && (artigo.getNumClasse() <= 93))
/*      */       {
/* 1249 */         ((GrupoAmbiguo)grupos.get(10)).add(artigo);
/* 1250 */       } else if ((artigo.getNumClasse() >= 185) && 
/* 1251 */         (artigo.getNumClasse() <= 196)) {
/* 1252 */         ((GrupoAmbiguo)grupos.get(11)).add(artigo);
/* 1253 */       } else if ((artigo.getNumClasse() >= 0) && (artigo.getNumClasse() <= -1))
/*      */       {
/* 1255 */         ((GrupoAmbiguo)grupos.get(12)).add(artigo);
/* 1256 */       } else if ((artigo.getNumClasse() >= 0) && (artigo.getNumClasse() <= -1))
/*      */       {
/* 1258 */         ((GrupoAmbiguo)grupos.get(13)).add(artigo);
/*      */       } else {
/* 1260 */         String[] authorName = artigo.getAutor().split(" ");
/*      */         
/* 1262 */         boolean found = false;
/* 1263 */         int i = 0;
/* 1264 */         while ((!found) && (i < grupos.size()))
/*      */         {
/* 1266 */           if (((GrupoAmbiguo)grupos.get(i)).getInicialPrimeiro() == authorName[0]
/* 1267 */             .charAt(0)) {
/* 1268 */             if (((GrupoAmbiguo)grupos.get(i)).getUltimoNome().equals(
/* 1269 */               authorName[(authorName.length - 1)])) {
/* 1270 */               ((GrupoAmbiguo)grupos.get(i)).add(artigo);
/* 1271 */               found = true;
/*      */             }
/*      */           }
/* 1274 */           i++;
...
/*      */   {
/* 1285 */     boolean[] inserido = new boolean[this.artigos.size()];
/* 1286 */     for (int i = 0; i < inserido.length; i++) {
/* 1287 */       inserido[i] = false;
/*      */     }
/*      */     
/* 1290 */     int cont = 0;
/* 1291 */     int numClasse = -1;
/* 1292 */     int inicioClasse = 0;int fimClasse = -1;
/* 1293 */     while (inicioClasse < this.artigos.size() - 1) {
/* 1294 */       numClasse++;
/*      */       
/* 1296 */       boolean ultimo = false;
/* 1297 */       while ((fimClasse < this.artigos.size() - 1) && (!ultimo)) {
/* 1298 */         if (((Artigo)this.artigos.get(fimClasse + 1)).getNumClasse() == ((Artigo)this.artigos.get(
/* 1299 */           inicioClasse)).getNumClasse()) {
/* 1300 */           fimClasse++;
/*      */         } else {
/* 1302 */           ultimo = true;
/*      */         }
/*      */       }
/* 1305 */       cont = (int)Math.round((fimClasse - inicioClasse + 1) * 0.5D);
/* 1306 */       Random random = new Random();
/* 1307 */       while (cont > 0) {
/* 1308 */         int i = random.nextInt(fimClasse - inicioClasse + 1);
/* 1309 */         if (inserido[(inicioClasse + i)] == 0) {
/* 1310 */           Artigo artigo = (Artigo)this.artigos.get(inicioClasse + i);
/*      */           
/*      */ 
/* 1313 */           inserido[(inicioClasse + i)] = true;
/* 1314 */           ((Artigo)this.artigos.get(inicioClasse + i)).setTreino(true);
/* 1315 */           cont--;
/*      */         }
/*      */       }
/*      */       
/* 1319 */       for (int i = inicioClasse; i <= fimClasse; i++)
/*      */       {
/* 1321 */         if (inserido[i] == 0) {
/* 1322 */           Artigo artigo = (Artigo)this.artigos.get(i);
/* 1323 */           artigo.setTreino(false);
/*      */         }
/*      */       }
/*      */       
/* 1327 */       inicioClasse = fimClasse + 1;
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/* 1338 */     boolean[] inserido = new boolean[this.artigos.size()];
/* 1339 */     for (int i = 0; i < inserido.length; i++) {
/* 1340 */       inserido[i] = false;
/*      */     }
/*      */     
/* 1343 */     int cont = 0;
/* 1344 */     int numClasse = -1;
/* 1345 */     int inicioClasse = 0;int fimClasse = -1;
/* 1346 */     while (inicioClasse < this.artigos.size() - 1) {
/* 1347 */       numClasse++;
/*      */       
/* 1349 */       boolean ultimo = false;
/* 1350 */       while ((fimClasse < this.artigos.size() - 1) && (!ultimo)) {
/* 1351 */         if (((Artigo)this.artigos.get(fimClasse + 1)).getNumClasse() == ((Artigo)this.artigos.get(
/* 1352 */           inicioClasse)).getNumClasse()) {
/* 1353 */           fimClasse++;
/*      */         } else {
/* 1355 */           ultimo = true;
/*      */         }
/*      */       }
/* 1358 */       cont = (int)Math.round((fimClasse - inicioClasse + 1) * 0.5D);
/* 1359 */       Random random = new Random();
/* 1360 */       while (cont > 0) {
/* 1361 */         int i = random.nextInt(fimClasse - inicioClasse + 1);
/* 1362 */         if (inserido[(inicioClasse + i)] == 0) {
/* 1363 */           Artigo artigo = (Artigo)this.artigos.get(inicioClasse + i);
/*      */           
/*      */ 
/* 1366 */           inserido[(inicioClasse + i)] = true;
/* 1367 */           ((Artigo)this.artigos.get(inicioClasse + i)).setTreino(true);
/* 1368 */           cont--;
/*      */         }
/*      */       }
/*      */       
/* 1372 */       for (int i = inicioClasse; i <= fimClasse; i++)
/*      */       {
/* 1374 */         if (inserido[i] == 0) {
/* 1375 */           Artigo artigo = (Artigo)this.artigos.get(i);
/* 1376 */           artigo.setTreino(false);
/*      */         }
/*      */       }
/*      */       
/* 1380 */       inicioClasse = fimClasse + 1;
/*      */     }
/*      */     
/* 1383 */     for (Iterator<Artigo> ia = this.artigos.iterator(); ia.hasNext();) {
/* 1384 */       if (((Artigo)ia.next()).isTreino()) {
/* 1385 */         ia.remove();
/*      */       }
/*      */     }
/*      */   }
...
/*      */   {
/* 1394 */     for (Iterator<Artigo> ia = this.artigos.iterator(); ia.hasNext();) {
/* 1395 */       if (((Artigo)ia.next()).isTreino()) {
/* 1396 */         ia.remove();
/*      */       }
/*      */     }
/*      */   }
...
/* 1402 */     return this.artigos;
/*      */   }
/*      */   
/*      */   public void setArtigos(ArrayList<Artigo> artigos) {
/* 1406 */     this.artigos = artigos;
/* 1407 */     this.lstTerm = criaListaTermos(true);
/*      */   }
/*      */   
/*      */   public void eliminaClassesMenores(int valor)
/*      */   {
/* 1412 */     int inicio = 0;
/* 1413 */     while (inicio < this.artigos.size()) {
/* 1414 */       int classe = ((Artigo)this.artigos.get(inicio)).getNumClasse();
/*      */       
/* 1416 */       int fim = inicio;
/* 1417 */       boolean achou = false;
/* 1418 */       while (!achou) {
/* 1419 */         fim++;
/* 1420 */         if ((fim >= this.artigos.size()) || 
/* 1421 */           (((Artigo)this.artigos.get(fim)).getNumClasse() != classe)) {
/* 1422 */           achou = true;
/* 1423 */           fim--;
/*      */         }
/*      */       }
/* 1426 */       int qtde = fim - inicio + 1;
/* 1427 */       if (qtde <= valor) {
/* 1428 */         for (int i = 0; i < qtde; i++)
/* 1429 */           this.artigos.remove(inicio);
/*      */       } else {
/* 1431 */         inicio = fim + 1;
/*      */       }
/*      */     }
...
/*      */   {
/* 1438 */     int[] qtdes = new int['æ'];
/* 1439 */     for (int i = 0; i < 230; i++)
/* 1440 */       qtdes[i] = 0;
/* 1441 */     for (int i = 0; i < this.artigos.size(); i++) {
/* 1442 */       if (!((Artigo)this.artigos.get(i)).isTreino()) {
/* 1443 */         qtdes[((Artigo)this.artigos.get(i)).getNumClasse()] += 1;
/*      */       }
/*      */     }
/*      */     
/*      */ 
/* 1448 */     for (Iterator<Artigo> iArt = this.artigos.iterator(); iArt.hasNext();) {
/* 1449 */       Artigo a = (Artigo)iArt.next();
/* 1450 */       if (qtdes[a.getNumClasse()] < limite)
/* 1451 */         iArt.remove();
/*      */     }
/*      */   }
/*      */   
/*      */   public ArrayList<TermIDF> getListTermIDFOrdem() {
/* 1456 */     ArrayList<TermIDF> lstIDF = new ArrayList();
/* 1457 */     for (Iterator<TermOcurrence> iTermos = this.lstTerm.iterator(); iTermos
/* 1458 */           .hasNext();) {
/* 1459 */       TermOcurrence termo = (TermOcurrence)iTermos.next();
/* 1460 */       double df = termo.getOcurrence();
/* 1461 */       double idf = this.artigos.size() / df;
/*      */       
/* 1463 */       TermIDF termoidf = new TermIDF(termo.getTerm(), idf);
/*      */       
/* 1465 */       lstIDF.add(termoidf);
/*      */     }
/* 1467 */     Collections.sort(lstIDF);
/* 1468 */     return lstIDF;
/*      */   }
/*      */   
/*      */   public void atualizaClasseRecebida(int id, int classeRecebida) {
/* 1472 */     Iterator<Artigo> iArt = getArtigos().iterator();
/* 1473 */     while (iArt.hasNext()) {
/* 1474 */       Artigo a = (Artigo)iArt.next();
/* 1475 */       if (a.getNumArtigo() == id) {
/* 1476 */         a.setNumClasseRecebida(classeRecebida);
/* 1477 */         return;
/*      */       }
/*      */     }
/* 1480 */     System.err.println("Artigo de numero " + id + "nao foi encontrado");
/*      */   }
/*      */   
/*      */   public Artigo getArtigo(int id) {
/* 1484 */     Iterator<Artigo> iArt = getArtigos().iterator();
/* 1485 */     while (iArt.hasNext()) {
/* 1486 */       Artigo a = (Artigo)iArt.next();
/* 1487 */       if (a.getNumArtigo() == id)
/*      */       {
/* 1489 */         return a;
/*      */       }
/*      */     }
/* 1492 */     System.err.println("Artigo de numero " + id + "nao foi encontrado");
/* 1493 */     return null;
/*      */   }
/*      */   
/*      */   public ArrayList<TermOcurrence> getLstTerm() {
/* 1497 */     return this.lstTerm;
/*      */   }
/*      */   
/*      */   public void setLstTerm(ArrayList<TermOcurrence> lstTerm) {
/* 1501 */     this.lstTerm = lstTerm;
/*      */   }
/*      */   
/*      */   public ArrayList<Grupo> criaGruposManuais() {
/* 1505 */     ArrayList<Grupo> grupos = new ArrayList();
/* 1506 */     Iterator<Artigo> iArt = this.artigos.iterator();
/* 1507 */     int numGrupo = -1;
/* 1508 */     Grupo grupo = null;
/* 1509 */     while (iArt.hasNext()) {
/* 1510 */       Artigo artigo = (Artigo)iArt.next();
/* 1511 */       numGrupo = artigo.getNumClasse();
/*      */       
/* 1513 */       boolean achou = false;
/* 1514 */       int j = 0;
/* 1515 */       while ((!achou) && (j < grupos.size()))
/* 1516 */         if (((Grupo)grupos.get(j)).getNumGrupo() == numGrupo) {
/* 1517 */           grupo = (Grupo)grupos.get(j);
/* 1518 */           achou = true;
/*      */         } else {
/* 1520 */           j++;
/*      */         }
/* 1522 */       if (!achou) {
/* 1523 */         grupo = new Grupo(numGrupo);
/* 1524 */         grupos.add(grupo);
/*      */       }
/* 1526 */       grupo.add(artigo);
/*      */     }
/*      */     
/* 1529 */     return grupos;
/*      */   }
...
/* 1533 */     ArrayList<Grupo> grupos = new ArrayList();
/* 1534 */     Iterator<Artigo> iArt = this.artigos.iterator();
/* 1535 */     int numGrupo = -1;
/* 1536 */     Grupo grupo = null;
/* 1537 */     while (iArt.hasNext()) {
/* 1538 */       Artigo artigo = (Artigo)iArt.next();
/* 1539 */       boolean achou = false;
/* 1540 */       int i = 0;
/* 1541 */       while ((!achou) && (i < grupos.size())) {
/* 1542 */         if (((Grupo)grupos.get(i)).getNumGrupo() == artigo
/* 1543 */           .getNumClasseRecebida()) {
/* 1544 */           ((Grupo)grupos.get(i)).add(artigo);
/* 1545 */           achou = true;
/*      */         }
/* 1547 */         i++;
/*      */       }
/* 1549 */       if (!achou) {
/* 1550 */         grupo = new Grupo(artigo.getNumClasseRecebida());
/* 1551 */         grupo.add(artigo);
/* 1552 */         grupos.add(grupo);
/*      */       }
/*      */     }
/*      */     
/* 1556 */     return grupos;
...
/* 1560 */     FileWriter f = new FileWriter(name);
/* 1561 */     for (Artigo a : getArtigos()) {
/* 1562 */       if (!a.isTreino())
/* 1563 */         f.write(a.toStringArqDen() + "\n");
/*      */     }
/* 1565 */     f.close();
/*      */   }
/*      */   
/*      */   public void gravaTreino(String name) throws IOException {
/* 1569 */     FileWriter f = new FileWriter(name);
/* 1570 */     for (Artigo a : getArtigos()) {
/* 1571 */       if (a.isTreino())
/* 1572 */         f.write(a.toStringArqDen() + "\n");
/*      */     }
/* 1574 */     f.close();
/*      */   }
/*      */ }
...
/* Location:              C:\Users\andres\Desktop\indi\indi.jar!\bdbcomp\Base.class
